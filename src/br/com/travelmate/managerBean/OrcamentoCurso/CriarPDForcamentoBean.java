...
public class CriarPDForcamentoBean {
	...
	public void criarCorpoEmail() throws IOException {
		 ...
		 corpo = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
                 ...
                 + "                            </div></td></tr></table></td></tr><td width= \"100% \" bgcolor= \"\"><img src= \""+logo.toString()+"\" width=\"204\" style=\"margin-left:3%\"/></td></tr><tr> <td><table border= \"0 \" cellspacing= \"0 \" cellpadding= \"0 \" width= \"100% \"><tr><td >\n"
                 + "                            <br></br><tr >\n"
         ...
         if(listaProdutos!=null){
	    	 for (int i = 0; i < listaProdutos.size(); i++) {
	             if (listaProdutos.get(i).getValorcoprodutos().getCoprodutos().getTipo().equalsIgnoreCase("Obrigatorio")){
	            	 corpo = corpo + 								"<tr >\n"
	                         ...
	                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(listaProdutos.get(i).getValorcoprodutos().getValororiginal()*ocurso.getNumerosemanas()) + "</td> \n"
	    	                 + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ "R$ "+Formatacao.formatarFloatString((listaProdutos.get(i).getValorcoprodutos().getValororiginal()*ocurso.getNumerosemanas())*ocurso.getCambio().getValor()) + "</td> \n"
	                         + "                                    </tr>\n";
	         ...
	         corpo = corpo + "                </table><table style=\"width:50%;margin-left:400px;position:right\" class=\"CSSTableGenerator\">\n"
	                 + "                                    <tr >\n"
	          ...
	          for (int n = 0; n < listaProdutos.size(); n++) {
	             if (listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getTipo().equalsIgnoreCase("Opcional")){
	                 corpo = corpo + "<strong style= \"margin-left:5.3%;font-size: 15px;margin-top: -3%;color: #257C67;\">Opcionais</strong><br />\n"
                         ...
                         + "                                    </tr>\n"
                         + "                                    <tr >\n"
                         + "									    <td style=\"color:#114A3D;width:200px \">" + listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getNome() + "</td>\n"
                         + "                                        <td style=\"color:#114A3D;width:200px \">" + listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getDescricao() + "</td>\n"
                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(listaProdutos.get(n).getValorcoprodutos().getValororiginal()*ocurso.getNumerosemanas()) + "</td> \n"
                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ "R$ "+Formatacao.formatarFloatString((listaProdutos.get(n).getValorcoprodutos().getValororiginal()*ocurso.getNumerosemanas()*ocurso.getCambio().getValor())) + "</td> \n"
                         + "                                    </tr>\n"
                         + "                                </table>\n"
                         + "                                <br></br>";
	             }
	             if (listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getTipo().equalsIgnoreCase("Acomodacao")){
	                 ...
	                 corpo = corpo + "<br></br><strong style= \"margin-left:5.3%;font-size: 15px;color: #257C67;\">Acomodação</strong><br />\n"
	                         ...
	                         + "                                    </tr>\n"
	                         + "                                    <tr >\n"
	                         + "                                        <td style=\"color:#114A3D \">" + listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getDescricao() + "</td>\n"
	                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(valorAcomodacao) + "</td> \n"
	                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ "R$ "+Formatacao.formatarFloatString((listaProdutos.get(n).getValorcoprodutos().getValororiginal()*ocurso.getNumerosemanas()*ocurso.getCambio().getValor())) + "</td> \n"
	                         + "                                    </tr>\n"
	                         + "                                </table>\n"
	                         + "                                <br></br>";
	             ...
	             if (listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getTipo().equalsIgnoreCase("AcOpcional")){
	                  ...
	                  corpo = corpo + "<br></br><strong style= \"margin-left:5.3%;font-size: 15px;color: #257C67;\">Opcional de Acomodação</strong><br />\n"
	                          ...
	                          + "                                    <tr >\n"
	                          + "                                        <td style=\"color:#114A3D \">" + listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getDescricao() + "</td>\n"
	                          + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(valorAcOpcional) + "</td> \n"
	                          + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ "R$ "+Formatacao.formatarFloatString(valorAcOpcional*ocurso.getCambio().getValor()) + "</td> \n"
	                          + "                                    </tr>\n"
	                          + "                                </table>\n"
	                          + "                                <br></br>";
	              }
	             if (listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getTipo().equalsIgnoreCase("Transfer")) {
	                 corpo = corpo + "<br></br><strong style= \"margin-left:5.3%;;font-size: 15px;margin-top: -3%;color: #257C67;\">Transfer</strong><br />\n"
	                         ...
	                         + "                                    <tr >\n"
	                         + "                                        <td style=\"color:#114A3D \">" + listaProdutos.get(n).getValorcoprodutos().getCoprodutos().getDescricao() + "</td>\n"
	                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(listaProdutos.get(n).getValorcoprodutos().getValororiginal()) + "</td> \n"
	                         + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ "R$ "+Formatacao.formatarFloatString(listaProdutos.get(n).getValorcoprodutos().getValororiginal()*ocurso.getCambio().getValor()) + "</td> \n"
	                         + "                                    </tr>\n"
	                         + "                                </table>\n"
	                         + "                                <br></br> <br></br>";
	             }
         ...
         for (int j = 0; j < resultadoOrcamentoBean.getListaOutrosProdutos().size(); j++) {
             corpo = corpo + "<strong style= \"margin-left:5.3%;font-size: 17px;margin-top: -3%;color: #257C67;\">Produtos Adicionais</strong><br />\n"
                     ...
                     + "                                    </tr>\n"
                     + "                                    <tr >\n"
                     + "										<td style=\"color:#114A3D;width:200px \">" + listaProdutos.get(j).getNome() + "</td>\n"
                     + "                                        <td style=\"color:#114A3D;width:200px \">" + listaProdutos.get(j).getDescricao() + "</td>\n"
    	             + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">R$ "+Formatacao.formatarFloatString(listaProdutos.get(j).getValororiginal()*ocurso.getCambio().getValor()) + "</td> \n"
                     + "                                        <td style=\"color:#114A3D;text-align: right;width: 90px\">"+ ocurso.getCambio().getMoedas().getSigla()+" "+Formatacao.formatarFloatString(listaProdutos.get(j).getValororiginal()) + "</td> \n"
                     + "                                    </tr>\n"
                     + "                                </table>\n"
                     + "                                <br></br>";
          }
         if (resultadoOrcamentoBean.isSeguroSelecionado()){
              corpo = corpo + "<strong style= \"margin-left:5.3%;font-size: 15px;margin-top: -3%;color: #257C67;\">Seguro Viagem</strong><br />\n"
                      ...
                      + "                                    </tr>\n"
                      + "                                    <tr >\n"
                      + "										  <td style=\"color:#114A3D;width:200px;font-size: 12px \">" + resultadoOrcamentoBean.getFornecedorcidade().getFornecedor().getNome() + "</td>\n"
                      + "                                         <td style=\"color:#114A3D;width:200px;font-size: 12px \">" + resultadoOrcamentoBean.getValoresSeguro().getPlano() + "</td>\n"
                      + "                                         <td style=\"color:#114A3D;font-size: 12px\">" + resultadoOrcamentoBean.getValoresSeguro().getCobranca() + "</td> \n"
                      + "                                    </tr>\n"
                      + "                                    <tr >\n"
                      + "                                        <td style=\"color:#AFCA0B;font-size:4px;background: #AFCA0B\">Curso </td>\n"
                      + "                                        <td style=\"color:#114A3D;text-align: right;background: #AFCA0B\"> </td> \n"
                      + "                                    </tr>\n"
                      + "                                    <tr >\n"
                      + "										  <td style=\"color:#114A3D;width:;width:300px;font-size: 12px \">Data Inicial:"+Formatacao.ConvercaoDataPadrao(resultadoOrcamentoBean.getSeguroviagem().getDataInicio())+ " |  Numero de Dias:"+ resultadoOrcamentoBean.getSeguroviagem().getNumeroSemanas() +" |  Data Final:" + Formatacao.ConvercaoDataPadrao(resultadoOrcamentoBean.getSeguroviagem().getDataTermino())+"</td> \n"
                      + "                                         <td style=\"color:#114A3D;text-align: right;width: 90px;font-size: 12px\">R$ "+Formatacao.formatarFloatString(resultadoOrcamentoBean.getSeguroviagem().getValorSeguro()) + "</td> \n"
                      + "                                    </tr>\n"
                      + "                                </table>\n"
                      + "                                <br></br>";
          }
         ...
         for (int d = 0; d < listaDesconto.size(); d++) {
        	 if(valorDesconto>0){
        		 valorDesconto = valorDesconto + listaDesconto.get(d).getValormoedanacional();
        	 }else{
        		 valorDesconto = listaDesconto.get(d).getValormoedanacional();
        	 }
         }
         if(valorDesconto>0){
         ...
         corpo = corpo + "<table style=\"width:50%;margin-left:400px;\" class=\"CSSTableGenerator\">\n"
                 + "                                    <tr >\n"
             ...
             corpo = corpo + "                  <strong style= \"margin-left:5.3%;font-size: 15px;color: #257C67;\">Custos Extras</strong>\n"
	        	 ...
	        	 corpo = corpo + "                      <tr >\n"
	             + "                                         <td style=\"color:#114A3D;font-size: 12px \"> Passagem Aérea: " + resultadoOrcamentoBean.getValorPassagemAerea() + "</td>\n"
	             + "                                    </tr> <br></br>\n";
	        	corpo = corpo  + "                       <tr >\n"
	             + "                                         <td style=\"color:#114A3D;font-size: 12px \"> Visto Consular: " + resultadoOrcamentoBean.getValorVistoConsular() + "</td>\n"
	             + "                                    </tr> <br></br><br></br>\n";
