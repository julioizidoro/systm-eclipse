		...
		if (validarCliente.getMsg().length() < 5) {
			...
			if (listaContas != null) {
				if (listaContas.size() > 0) {
					...
					gerarBoletoConsultorBean.gerarBoleto(listaContas, String.valueOf(curso.getVendas().getIdvendas()), true);
				} else {
...
//	}
	...
	public String escolherApplication1(Curso cursos) {
		if (cursos.isUploadapplication()) {
			...
			RequestContext.getCurrentInstance().openDialog("escolherApplication");
		}
		return "";
	}
