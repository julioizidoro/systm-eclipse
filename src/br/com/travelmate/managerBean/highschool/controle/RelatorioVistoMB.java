...
@Named
@ViewScoped
public class RelatorioVistoMB implements Serializable{
    ...
    public String gerarSql(){
        String sql = "SELECT distinct cliente.nome, cliente.dataNascimento, vendas.dataVenda, cliente.foneCelular,"
                ...
                + " highschool.escolaIntercambio as nomeEscola, "
                + " controlehighschool.visto, controlehighschool.dataaplicacaovisto, controlehighschool.datadocumentacaovisto"
    ...
    public String gerarRelatorio() throws SQLException, IOException {
        ...
        String caminhoRelatorio = "/reports/controlehighschool/relatorioVisto.jasper";  
