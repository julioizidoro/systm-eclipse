...
@Named
@ViewScoped
public class RelatorioPassagensMB implements Serializable{
    ...
    public String gerarSql(){
        String sql = "SELECT distinct cliente.nome, cliente.dataNascimento, vendas.dataVenda, cliente.foneCelular,"
                ...
                + " highschool.escolaIntercambio as nomeEscola, controlehighschool.dataEmbarque, controlehighschool.dataRetorno,"
                + " controlehighschool.embarquecidade, controlehighschool.embarqueciaaerea, controlehighschool.embarquenumerovoo,"
                + " controlehighschool.embarquehorariovoo, controlehighschool.conexaocidade, controlehighschool.conexaociaarea, "
                + " controlehighschool.conexaonumerovoo, controlehighschool.conexaohorariovoo, controlehighschool.chegadacidade, "
                + " controlehighschool.chegadahorario, controlehighschool.aeroportofinal"
    ...
    public String gerarRelatorio() throws SQLException, IOException {
        ...
        String caminhoRelatorio = "/reports/controlehighschool/relatorioPassagem.jasper";  
        ...
        try {
            gerarRelatorio.gerarRelatorioSqlPDF(caminhoRelatorio, parameters, "Relatório de Passagens.pdf", null);
        } catch (JRException ex) {
            Logger.getLogger(RelatorioPassagensMB.class.getName()).log(Level.SEVERE, null, ex);
