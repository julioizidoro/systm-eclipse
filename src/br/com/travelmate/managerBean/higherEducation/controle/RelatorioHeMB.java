...
public class RelatorioHeMB implements Serializable {
	...
	public void pesquisar() {
		...
		if (datainiembarque != null && datafinalembarque != null) {
			sql = sql + " AND h.he.vendas.vendasembarque.dataida>='" + Formatacao.ConvercaoDataSql(datainiembarque)
					+ "' AND h.he.vendas.vendasembarque.dataida<='" + Formatacao.ConvercaoDataSql(datafinalembarque) + "'";
		}
