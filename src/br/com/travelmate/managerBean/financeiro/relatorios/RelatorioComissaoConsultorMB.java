...
public class RelatorioComissaoConsultorMB implements Serializable{
    ...
    public void gerarListaConsultor(){
        ...
        listaConsultor = usuarioFacade.listar("select u from Usuario u where u.situacao='Ativo' order by u.nome");
    ...
    public String gerarRelatorio() throws SQLException, IOException {
        ...
        try {
            gerarRelatorio.gerarRelatorioSqlPDF(caminhoRelatorio, parameters, "comissaoConsultor.pdf", null);
